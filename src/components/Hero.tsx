    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-7 lg:col-span-7 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-4">
              <button
                ...
                className="px-6 py-3 rounded-2xl font-semibold text-white shadow-lg hover:shadow-xl transition"
                style={{
                  background: "linear-gradient(90deg,#49BFC9,#5F8DFF,#9A8DFF)",
                }}
              >
              ...
              <a
                href="#contact"
                className="px-6 py-3 border-2 rounded-2xl transition font-semibold"
                style={{
                  borderColor: "#5F8DFF",
                  color: "#9AB9FF",
                }}
          ...
          {/* Right avatar */}
          <div className="hidden sm:flex md:col-span-5 lg:col-span-5 justify-end">
            <motion.div
