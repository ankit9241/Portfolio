          ...
          <AnimatePresence>
               {isVisible && (
                    <motion.nav
                         ...
                         className="fixed right-3 sm:right-4 md:right-5 lg:right-6 xl:right-8 top-1/2 -translate-y-1/2 z-50 hidden md:flex flex-col items-center gap-1 p-1.5 rounded-full"
                         style={{
