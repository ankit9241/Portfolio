...
import { LuWorkflow, LuBrain, LuSparkles, LuNetwork, LuScanFace, LuCpu, LuShieldCheck, LuWifiOff, LuDatabase, LuRefreshCw } from "react-icons/lu";
...
export const technologies = {
  ...
  llm: {
    name: "LLMs",
    icon: LuBrain,
    bgColor: "rgba(137, 170, 204, 0.12)",
    textColor: "#89AACC",
    borderColor: "rgba(137, 170, 204, 0.35)",
  },
  generativeAi: {
    name: "Generative AI",
    icon: LuSparkles,
    bgColor: "rgba(225, 224, 204, 0.12)",
    textColor: "#E1E0CC",
    borderColor: "rgba(225, 224, 204, 0.35)",
  },
  langgraph: {
    name: "LangGraph",
    icon: LuWorkflow,
  ...
  awsS3: {
    name: "Amazon S3",
    icon: SiAmazons3,
    bgColor: "rgba(235, 78, 61, 0.1)",
    textColor: "#E74C3C",
    borderColor: "rgba(235, 78, 61, 0.3)",
  },
  computerVision: {
